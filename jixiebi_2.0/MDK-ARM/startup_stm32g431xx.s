...
; --- ���������ܴ��룬ǿ�ƹر� PA4 �� PA6 ---
        LDR     R0, =0x4002104C    ; RCC_AHB2ENR �Ĵ�����ַ (���� GPIOA ʱ��)
        LDR     R1, [R0]
        ORR     R1, R1, #0x00000001 ; ��λ�� 0 λ������ GPIOA ʱ��
        STR     R1, [R0]

        LDR     R0, =0x40020000    ; GPIOA ����ַ
        
        ; ����Ϊ�������ģʽ (MODER: PA4=bit8-9, PA6=bit12-13. ����Ϊ 01 �����)
        LDR     R1, [R0, #0x00]    ; GPIOA_MODER
        BIC     R1, R1, #0x00003300 ; ����� bit 8,9,12,13
        ORR     R1, R1, #0x00001100 ; ����Ϊ 01 (General purpose output mode)
        STR     R1, [R0, #0x00]

        ; ����Ϊ���� (PUPDR: PA4=bit8-9, PA6=bit12-13. ����Ϊ 10 ������)
        LDR     R1, [R0, #0x0C]    ; GPIOA_PUPDR
        BIC     R1, R1, #0x00003300 ; ���
        ORR     R1, R1, #0x00002200 ; ����Ϊ 10 (Pull-down)
        STR     R1, [R0, #0x0C]

        ; �������͵�ƽ (BSRR: �� 16 λ�����λ)
        LDR     R1, =0x00500000    ; �� 20 λ�� 22 λ (PA4 �� PA6 �� Reset λ)
        STR     R1, [R0, #0x18]    ; GPIOA_BSRR
; --- ���ܴ������ ---
